...
class Cache {
    ...
    async findOrCreatePlotter(upstream, plotterId) {
        return this.processingQueue.push({type: 'find-or-create-plotter', data: { upstream, plotterId }});
    }

    async createOrUpdateRound(roundPrototype) {
        return this.processingQueue.push({type: 'create-or-update-round', data: roundPrototype});
    }
    ...
    async saveEntity(entity) {
        return this.processingQueue.push({type: 'save-entity', data: entity});
    }
