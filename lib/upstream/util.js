...
async function getBlockWinnerAccountId(url, isBHD, height, customEndpoint = null) {
...
async function getBlockWinnerAccountIdOrNull(url, isBHD, height, customEndpoint = null) {
  try {
    if (isBHD) {
