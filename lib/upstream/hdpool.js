      ...
      this.client.addEventListener('message', async (msg) => {
        ...
        switch (data.cmd) {
          ...
          case 'poolmgr.mining_info':
            ...
            break;
          default:
            console.log(`${new Date().toISOString()} | ${this.fullUpstreamNameLogs} | unknown command ${data.cmd} with data: ${JSON.stringify(data)}. Please message this info to the creator of this software.`);
        }
      });
    });
